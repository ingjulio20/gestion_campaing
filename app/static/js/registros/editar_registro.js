...
const get_Municipios = () => {
    ...
    municipio.innerHTML = `<option value="" selected></option>`
    fetch("/getMunicipios", {
        method: "POST",
        headers: {
...
/* Validar Formulario */
const formUpdateRegistro = document.getElementById("formUpdateRegistro");
formUpdateRegistro.addEventListener("submit", (e) => {
