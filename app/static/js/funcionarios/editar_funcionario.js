...
const formUpdateFuncionario = document.getElementById("formUpdateFuncionario");
...
const habilitarPaneles = () => {
    ...
    if(valor === "2"){
        ...
        panelEnlaceAsociado.classList.add('is-hidden');
        admin_asociado.required = false;
        admin_asociado.value = "";
        enlace_asociado.required = false;
        enlace_asociado.value = "";
    }
};
...
/* Validar Formulario */
formUpdateFuncionario.addEventListener("submit", (e) => {
    /* Variables */
