...
INSERT INTO `etnias` (`cod_etnia`, `nom_etnia`) VALUES
(1, 'Indigena'),
(2, 'ROM (Gitano)'),
...
INSERT INTO `municipios` (`cod_municipio`, `nom_municipio`, `cod_depto`) VALUES
('05001', 'MEDELLÍN', '05'),
('05002', 'ABEJORRAL', '05'),
('05004', 'ABRIAQUÍ', '05'),
('05021', 'ALEJANDRÍA', '05'),
...
INSERT INTO `tipos_documento` (`cod_tipo`, `nom_tipo`) VALUES
...
('PA', 'Pasaporte'),
('PE', 'Permiso Especial del Permanencia'),
...
CREATE TABLE `usuarios` (
  `doc_usuario` varchar(50) DEFAULT NULL,
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `usuarios_ibfk_1` FOREIGN KEY (`perfil`) REFERENCES `perfiles_usuarios` (`id_perfil`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
